...
To run this code, you'll want to highlight the code in the text editor and then hit Cmd + E on Macs or Ctrl + E on Windows. Additionally, there is a 'Run' button in the top right corner of the text editor which does the same.
